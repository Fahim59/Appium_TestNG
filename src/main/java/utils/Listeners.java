...
public class Listeners implements ITestListener {
    ...
    private Sheet sheet;
    private List<Listeners.TestInfo> testInfos;
    ...
    public void onTestFailure(ITestResult result) {
        ...
        testInfos.add(new Listeners.TestInfo(methodName, "Failed"));
    }
    ...
    public void onFinish(ITestContext iTestContext) {
        ...
        try (FileOutputStream outputStream = new FileOutputStream("E:\\Intellij Files\\Excel Files\\Test_Result_Appium.xlsx")) {
    ...
    public void onTestSuccess(ITestResult result) {
        String methodName = result.getMethod().getMethodName();
        testInfos.add(new Listeners.TestInfo(methodName, "Passed"));
